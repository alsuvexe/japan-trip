...
import { Plus, Hotel, UtensilsCrossed, Clock, X, Trash2 } from 'lucide-react';
import { useTrips } from '../lib/TripContext';
import GenericResumen from './sections/GenericResumen';
...
export default function GenericTripView({ activeSection, onSectionChange }: GenericTripViewProps) {
  ...
  const renderResumen = () => (
    <GenericResumen onSectionChange={onSectionChange} />
  );
